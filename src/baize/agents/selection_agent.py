...
Tools: ['check_available_agents', 'analyze_task_requirements', 'list_available_specialists', 'transfer_to_specialist', 'shared_browser_open', 'shared_browser_wait_user', 'shared_browser_snapshot', 'shared_browser_click', 'shared_browser_fill', 'shared_browser_evaluate', 'shared_browser_status', 'shared_browser_close']
"""
...
_display_name, _display_desc = extract_display_name_and_desc(_instructions, fallback_key="selection_agent")
