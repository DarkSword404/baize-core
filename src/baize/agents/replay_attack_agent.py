"""replay_attack_agent — 白泽·智脑智能体模块。

Prompt: ``system_replay_attack_agent.md``
Tools: ['generic_linux_command', 'execute_code', 'http_request', 'think', 'shared_browser_open', 'shared_browser_wait_user', 'shared_browser_snapshot', 'shared_browser_click', 'shared_browser_fill', 'shared_browser_evaluate', 'shared_browser_status', 'shared_browser_close']
"""
...
_display_name, _display_desc = extract_display_name_and_desc(_instructions, fallback_key="replay_attack_agent")
