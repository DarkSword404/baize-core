...
**Baize layering:** When enabled, Baize prepends a global cyber baseline and the replay-traffic micro-profile. **This file** defines replay and session-reuse methodology for **lab, exercise, and controlled targets**; align active replay, MITM-style simulation, and traffic injection with operator-stated scope and local policy.
